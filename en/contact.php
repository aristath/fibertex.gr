...
<html lang="en">
  ...
  <body class="company" data-spy="scroll" data-target=".bs-docs-sidebar" class="contact">
    ...
    <div class="row">
      <div class="span3 bs-docs-sidebar">
        <ul class="nav nav-list bs-docs-sidenav">
          ...
          <li><a href="./company.html"><i class="icon-chevron-right"></i>The Company</a></li>
          <li><a href="./vision.html"><i class="icon-chevron-right"></i>Vision</a></li>
